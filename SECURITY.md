...
If you find a security vulnerability in Gravitational Lensing, please report it through [GitHub's private vulnerability reporting](https://github.com/GitArrenDave/GraviLens/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact david_johann@web.de for details.
